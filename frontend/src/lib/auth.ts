export const AUTH_COOKIE = 'ai_whatsapp_commerce_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-whatsapp-commerce.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-whatsapp-commerce.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-whatsapp-commerce.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
