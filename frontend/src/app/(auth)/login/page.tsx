...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded AI WhatsApp Commerce demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        ...
        <h1 style={{ marginBottom: 8 }}>AI WhatsApp Commerce login</h1>
        <div className="muted">
          One login for ai whatsapp commerce features, source tables, documents, notifications, audit, approvals, and AI operations.
        </div>
