...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI WhatsApp Commerce Suite Dashboard"
      subtitle="One merged ai whatsapp commerce view for WhatsApp Storefront, Catalog Q&A, Order Status, Cart Recovery, Lead Capture, Payment Handoff, Support Inbox, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai whatsapp commerce jobs into one surface. WhatsApp Storefront, Catalog Q&A, Order Status, Cart Recovery, Lead Capture, Payment Handoff, Support Inbox, source tables, documents, audit, and AI are presented as platform features.
          </div>
